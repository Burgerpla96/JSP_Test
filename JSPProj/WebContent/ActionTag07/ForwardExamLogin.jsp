...
<body>
	<fieldset>
		...
		<form action="ForwardExamProcess.jsp" method="post">
			아이디<input type= "text" name = "user" value='<%= request.getParameter("name")==null? "": request.getParameter("name")%>'/>
			비밀번호<input type="text" name="pass" value='<%= request.getParameter("pass")==null? "": request.getParameter("pass")%>' />
